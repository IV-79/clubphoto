...
export class DefiCreer {
  ...
  form = new FormGroup(
    {
      ...
      dateDebutSoumission: new FormControl(this.today, {
      ...
      dateCloturVotes: new FormControl('', {
        validators: [Validators.required],
        nonNullable: true,
      }),
      maxPhotos: new FormControl(2, {
  ...
  get dateErrors(): string | null {
    ...
    if (e['voteAvantFin'])
      return 'La date de clôture des votes doit être après la fin des soumissions.';
    return null;
  }
