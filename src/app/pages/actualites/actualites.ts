...
@Component({
  ...
  template: `
    <div class="page-wrap">
      ...
      <div class="filters">
        <button class="chip" [class.active]="activeType() === null" (click)="activeType.set(null)">
          Tous
        </button>
  ...
  styles: [
    `
      ...
      .chip.active {
        background: var(--c, var(--text-accent));
        color: #fff;
        border-color: var(--c, var(--text-accent));
      }
